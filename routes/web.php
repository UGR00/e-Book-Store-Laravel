...
Route::group(['namespace'=>'admin', 'prefix'=>'admin', 'as'=>'admin.','middleware'=>['auth','AdminCtrl']], function() {
    ...
    Route::group(['namespace'=>'yayinevi', 'prefix'=>'yayinevi', 'as'=>'yayinevi.'], function() {
        ...
        Route::get('/düzenle/{id}', [App\Http\Controllers\admin\yayinevi\indexController::class, 'edit'])->name('edit');
        Route::post('/düzenle/{id}', [App\Http\Controllers\admin\yayinevi\indexController::class, 'update'])->name('edit.post');
    ...
    Route::group(['namespace'=>'yazar', 'prefix'=>'yazar', 'as'=>'yazar.'], function() {
        ...
        Route::get('/düzenle/{id}', [App\Http\Controllers\admin\yazar\indexController::class, 'edit'])->name('edit');
        Route::post('/düzenle/{id}', [App\Http\Controllers\admin\yazar\indexController::class, 'update'])->name('edit.post');
    ...
    Route::group(['namespace'=>'kitap', 'prefix'=>'kitap', 'as'=>'kitap.'], function() {
        ...
        Route::get('/düzenle/{id}', [App\Http\Controllers\admin\kitap\indexController::class, 'edit'])->name('edit');
        Route::post('/düzenle/{id}', [App\Http\Controllers\admin\kitap\indexController::class, 'update'])->name('edit.post');
    ...
    Route::group(['namespace'=>'slider', 'prefix'=>'slider', 'as'=>'slider.'], function() {
        ...
        Route::get('/düzenle/{id}', [App\Http\Controllers\admin\slider\indexController::class, 'edit'])->name('edit');
        Route::post('/düzenle/{id}', [App\Http\Controllers\admin\slider\indexController::class, 'update'])->name('edit.post');
